...
def clear_database():
    ...
    if not os.path.exists(db_path):
        logger.error("Database file not found.", extra={"event": "db_clear", "status": "missing", "db_path": db_path})
        return
    
    logger.info("Clearing database", extra={"event": "db_clear", "status": "starting", "db_path": db_path})
    ...
    try:
        ...
        logger.info("Database cleared successfully", extra={"event": "db_clear", "status": "success"})
        logger.info("Ready to start fresh - you can now run the app!", extra={"event": "db_clear", "next": "run_app"})
